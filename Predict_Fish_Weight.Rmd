...
Based on this Model, the best two regression model for Smelt is Length2 and Width. I don't believe it is the overall best model if we are going based on the Adjusted R-squared value because it is in between two different values, 0.96 and 0.97. It appears that the overall best regression models for Smelt are the 3 and 5 regressor models because they align almost perfectly with the adjusted R-squared. 
